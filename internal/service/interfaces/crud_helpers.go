...
type interfaceResourceClient struct {
	client opnsense.Client
}

func (c *interfaceResourceClient) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
type interfaceDataSourceClient struct {
	client opnsense.Client
}

func (c *interfaceDataSourceClient) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	if req.ProviderData == nil {
		return
	}
	apiClient, ok := req.ProviderData.(*api.Client)
...
type interfaceCRUDOperations[Model any, APIModel any] struct {
	Name    string
...
func createInterfaceResource[Model any, APIModel any](ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse, ops interfaceCRUDOperations[Model, APIModel]) {
	var data Model
	...
	tflog.Trace(ctx, "created interface resource", map[string]any{"type": ops.Name, "id": id})
}

func readInterfaceResource[Model any, APIModel any](ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse, ops interfaceCRUDOperations[Model, APIModel]) {
	var data Model
...
func updateInterfaceResource[Model any, APIModel any](ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse, ops interfaceCRUDOperations[Model, APIModel]) {
	var data Model
	resp.Diagnostics.Append(req.Plan.Get(ctx, &data)...)
	if resp.Diagnostics.HasError() {
		return
...
func deleteInterfaceResource[Model any, APIModel any](ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse, ops interfaceCRUDOperations[Model, APIModel]) {
	var data Model
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
	if resp.Diagnostics.HasError() {
		return
...
func readInterfaceDataSource[Model any, APIModel any](ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse, name string, get func(context.Context, string) (*APIModel, error), expand func(*APIModel) (*Model, error), getID func(*Model) string, setID func(*Model, string)) {
	var data Model
